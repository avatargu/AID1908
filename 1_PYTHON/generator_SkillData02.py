...
def get_skill(list_target,func_condition):
...
for item in get_skill(list_skill,func_condition01):
    print(item)

print("# 2 -----------------------------------------------------------------------------------------")

for item in get_skill(list_skill,func_condition02):
    print(item)

print("# 3 -----------------------------------------------------------------------------------------")
print("# 4 -----------------------------------------------------------------------------------------")

for item in get_skill(list_skill,func_condition04):
    print(item)